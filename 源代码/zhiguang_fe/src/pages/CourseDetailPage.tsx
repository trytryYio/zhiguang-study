            ...
            <article className={styles.detailCard}>
                ...
                <div className={styles.contentRow}>
                    <div className={styles.contentMain}>
                        ...
                        {contentError ? (
                            <div style={{color: "var(--color-danger)"}}>{contentError} {detail?.contentUrl ? (
                                <a href={detail.contentUrl} target="_blank" rel="noreferrer">查看原文</a>) : null}</div>
                        ) : null}
                    </div>
              ...
              />
                            <div className={styles.ragControls}>
                                ...
                                <button type="button" className={`${styles.ragBtn} ${styles.ragBtnGhost}`}
                                        onClick={stopRag} disabled={!ragLoading}>
                                    停止
                                </button>
                            </div>
