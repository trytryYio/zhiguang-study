...
public class SearchServiceImpl implements SearchService {
    ...
    public SearchResponse search(String q, int size, String tagsCsv, String after, Long currentUserIdNullable) {
        ...
        for (Hit<Map<String, Object>> hit : hits) {
            ...
            Boolean liked = currentUserIdNullable != null && counterService.isLiked("zhiguang/nauy/knowpost", id, currentUserIdNullable);
            Boolean faved = currentUserIdNullable != null && counterService.isFaved("zhiguang/nauy/knowpost", id, currentUserIdNullable);
