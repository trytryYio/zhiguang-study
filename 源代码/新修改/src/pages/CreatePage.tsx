                ...
                <div className={styles.formGrid}>
                    ...
                    <div className={`${styles.field} ${styles.fullWidth}`}>
                        ...
                        >
                            ...
                            <small>支持 JPG / PNG / SVG，最多 {MAX_IMAGES} 张；单张不超过
                                5MB（已选 {uploadedImgUrls.length} / {MAX_IMAGES}）</small>
                            <input
                                ref={fileInputRef}
                                type="file"
                                accept="image/*"
                        ...
                        <div className={styles.fieldHeader}>
                            ...
                            <div className={styles.headActions}>
                                ...
                                <div
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === "Enter" || e.key === " ") handleToggleAiSummary();
                                    }}
                                />
                    ...
                    <div className={`${styles.field} ${styles.fullWidth}`}>
                        <div
                            ...
                            onKeyDown={(e) => {
                                if (e.key === "Enter" || e.key === " ") setIsFree(prev => !prev);
                            }}
                        >
                            <div>
                    ...
                    <div className={`${styles.field} ${styles.fullWidth}`}>
                        <div
                            ...
                            onKeyDown={(e) => {
                                if (e.key === "Enter" || e.key === " ") setVisiblePublic(prev => !prev);
                            }}
                        >
                            <div>
