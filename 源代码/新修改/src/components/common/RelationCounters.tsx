        ...
        <>
            {counts ? (
                <div className={styles.wrapper}>
                    <div className={`${styles.item} ${styles.clickable}`} onClick={() => {
                        setMode("following");
                        setOpen(true);
                    }}>
                    ...
                    <div className={styles.item}><span className={styles.number}>{counts.posts}</span><span
                        className={styles.label}>发帖</span></div>
                    <div className={styles.item}><span className={styles.number}>{counts.likedPosts}</span><span
                        className={styles.label}>获赞</span></div>
                    <div className={styles.item}><span className={styles.number}>{counts.favedPosts}</span><span
                        className={styles.label}>获藏</span></div>
                </div>
            ) : null}
